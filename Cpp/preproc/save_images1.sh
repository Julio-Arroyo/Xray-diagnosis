...
#SBATCH --job-name=part1_allTrain_224x224

# Output and error log locations (captures stdout and stderr respectively). Defaults to your homedir.
#SBATCH --output=/groups/CS156b/2023/Xray-diagnosis/Cpp/out/part1_allTrain_224x224.out
#SBATCH --error=/groups/CS156b/2023/Xray-diagnosis/Cpp/out/part1_allTrain_224x224.err
...
python3 /groups/CS156b/2023/Xray-diagnosis/Cpp/preproc/save_images.py --start 0 --num-images 60000 --image-dims 224 --part 1
