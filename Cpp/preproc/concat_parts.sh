...
#SBATCH --job-name=concat_parts

# Output and error log locations (captures stdout and stderr respectively). Defaults to your homedir.
#SBATCH --output=/groups/CS156b/2023/Xray-diagnosis/Cpp/out/concat_parts.out
#SBATCH --error=/groups/CS156b/2023/Xray-diagnosis/Cpp/out/concat_parts.err
...
python3 /groups/CS156b/2023/Xray-diagnosis/Cpp/preproc/concat_parts.py
