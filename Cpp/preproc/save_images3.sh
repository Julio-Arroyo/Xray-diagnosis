...
#SBATCH --job-name=part3_allTrain_224x224

# Output and error log locations (captures stdout and stderr respectively). Defaults to your homedir.
#SBATCH --output=/groups/CS156b/2023/Xray-diagnosis/Cpp/out/part3_allTrain_224x224.out
#SBATCH --error=/groups/CS156b/2023/Xray-diagnosis/Cpp/out/part3_allTrain_224x224.err
...
python3 /groups/CS156b/2023/Xray-diagnosis/Cpp/preproc/save_images.py --start 119079 --num-images 59078 --image-dims 224 --part 3
